...
public class Word implements Serializable {
    ...
    //get suggested translation for an English word entered via API
    public static String getWordData(String word) throws IOException{
        HttpURLConnection connection = (HttpURLConnection) 
            new URL("https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20220201T201800Z.e88c0765cc58230d.77205ba94b1a7962d5e73561bf7cae791f81a1c4&lang=en-vi&text=" 
                    + word).openConnection();        
